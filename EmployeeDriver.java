...
//        boolean retry = false;
        ...
        do
        {
            ...
            System.out.println("\n\nMain Menu\n");
            em.listAll();
            mainInput = menu("Employee Submenu", "Add Employee", "Remove Employee", "Calculate Weekly Payout", "Calculate Bonus", "Annual Raises", "Reset Week", "Find Employee", "Sort Employees", "Quit");
