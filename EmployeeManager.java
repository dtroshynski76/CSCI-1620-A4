...
public class EmployeeManager
{
    ...
    public void listHourly()
    {
        ...
        for (int y = 0; y < employees.lengthIs(); y++)
        {
            if (employees.getItem(y) instanceof HourlyEmployee)
            {
                hourlyEmployee = true;
                System.out.println();
                System.out.println(employees.getItem(y));
                System.out.println();
            }
        }
    ...
    public void listSalary()
    {
        ...
        for (int y = 0; y < employees.lengthIs(); y++)
        {
            if (employees.getItem(y) instanceof SalaryEmployee)
            {
                salaryEmployee = true;
                System.out.println();
                System.out.println(employees.getItem(y));
    ...
    public void listCommission()
    {
        ...
        for (int y = 0; y < employees.lengthIs(); y++)
        {
            if (employees.getItem(y) instanceof CommissionEmployee)
            {
